...
class BriefDescriptionHandler : public DocParaImpl, public BaseHandler<BriefDescriptionHandler>
{
  public:
    friend class BriefDescriptionParaIterator;
    BriefDescriptionHandler(IBaseHandler *parent);
    virtual ~BriefDescriptionHandler();
    virtual void startInternal(const QXmlAttributes& attrib);
    virtual void endInternal();
    virtual void startParagraph(const QXmlAttributes& attrib);
...
class BriefDescriptionParaIterator : public BaseIteratorVia<IDocIterator,IDoc,DocImpl,DocImpl>
{
  public:
    BriefDescriptionParaIterator(const BriefDescriptionHandler &handler) : 
      BaseIteratorVia<IDocIterator,IDoc, DocImpl, DocImpl>(handler.m_paragraphs) {}
};


class DetailDescriptionHandler : public DocParaImpl, public BaseHandler<DetailDescriptionHandler>
{
  public:
    friend class DetailDescriptionParaIterator;
    DetailDescriptionHandler(IBaseHandler *parent);
    virtual ~DetailDescriptionHandler();
    virtual void startInternal(const QXmlAttributes& attrib);
    virtual void endInternal();
    virtual void startParagraph(const QXmlAttributes& attrib);
...
class DetailDescriptionParaIterator : public BaseIteratorVia<IDocIterator,IDoc,DocImpl,DocImpl>
{
  public:
    DetailDescriptionParaIterator(const DetailDescriptionHandler &handler) : 
      BaseIteratorVia<IDocIterator,IDoc,DocImpl,DocImpl>(handler.m_paragraphs) {}
};
...
class DocHandler : public DocRootImpl, public BaseHandler<DocHandler>
{
  ...
  public:
    ...
    virtual void endDoc();
    virtual void startBriefDescription(const QXmlAttributes& attrib);
    virtual void startDetailDescription(const QXmlAttributes& attrib);
    virtual void startParagraph(const QXmlAttributes& attrib);
...
// class DocIterator : public BaseIteratorVia<IDocIterator,IDoc, ParagraphHandler,DocImpl>
{
  public:
    DocIterator(const DocHandler &handler) : 
	  BaseIteratorVia<IDocIterator,IDoc, DocImpl,DocImpl>(handler.m_children) {}
      // BaseIteratorVia<IDocIterator,IDoc, ParagraphHandler,DocImpl>(handler.m_children) {}
};
