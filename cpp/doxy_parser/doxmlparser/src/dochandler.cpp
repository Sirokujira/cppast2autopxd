...
void ParagraphHandler::addTextNode()
{
  if (!m_curString.isEmpty())
  {
    ...
    printf("addTextNode() text=\"%s\" markup=%x headingLevel=%d\n",
           m_curString.data(),
           m_markupHandler->markup(),
           m_markupHandler->headingLevel());
    m_text = m_curString;
...
{
  printf("ParagraphHandler:contents().\n");
...
//-----------------------------------------------------------------------
// BriefDescriptionHandler
//----------------------------------------------------------------------
BriefDescriptionHandler::BriefDescriptionHandler(IBaseHandler *parent)
  : m_parent(parent)
{
  m_paragraphs.setAutoDelete(TRUE);
  addEndHandler("briefdescription",this,&BriefDescriptionHandler::endInternal);
  addStartHandler("para",this,&BriefDescriptionHandler::startParagraph);
  addEndHandler("para", this, &BriefDescriptionHandler::endInternal);
}

BriefDescriptionHandler::~BriefDescriptionHandler()
{
}

void BriefDescriptionHandler::startInternal(const QXmlAttributes&)
{
  m_parent->setDelegate(this);
  debug(2,"Start internal\n");
  // m_curString = "";
...
void BriefDescriptionHandler::endInternal()
{
  // addTextNode();
  m_parent->setDelegate(0);
  debug(2,"End internal\n");
...
void BriefDescriptionHandler::startParagraph(const QXmlAttributes& attrib)
{
  ParagraphHandler *parHandler = new ParagraphHandler(this);
  parHandler->startParagraph(attrib);
  m_paragraphs.append(parHandler);
...
// void BriefDescriptionHandler::addTextNode()
// {
//   if (!m_curString.isEmpty())
//   {
//     // m_children.append(new TextNode(
//     //                   			   m_curString,
//     //                   			   m_markupHandler->markup(),
//     //                   			   m_markupHandler->headingLevel()
//     //                               )
...
IDocIterator *BriefDescriptionHandler::contents() const
{
  return new BriefDescriptionParaIterator(*this);
}
...
//----------------------------------------------------------------------
DetailDescriptionHandler::DetailDescriptionHandler(IBaseHandler *parent)
  : m_parent(parent)
{
  m_paragraphs.setAutoDelete(TRUE);
  addEndHandler("detaildescription",this,&DetailDescriptionHandler::endInternal);
  addStartHandler("para", this, &DetailDescriptionHandler::startParagraph);
  addEndHandler("para", this, &DetailDescriptionHandler::endInternal);

  // addStartHandler("parameterlist",this, &DetailDescriptionHandler::startParameterList);
  // addEndHandler("parameterlist",this,&ParameterListHandler::endParameterList);
  // addStartHandler("parameteritem",this,&ParameterListHandler::startParameterItem);
  // m_paramItems.setAutoDelete(TRUE);
...
DetailDescriptionHandler::~DetailDescriptionHandler()
{
}

void DetailDescriptionHandler::startInternal(const QXmlAttributes&)
{
  m_parent->setDelegate(this);
  debug(2,"Start internal\n");
}

void DetailDescriptionHandler::endInternal()
{
  m_parent->setDelegate(0);
  debug(2,"End internal\n");
}

void DetailDescriptionHandler::startParagraph(const QXmlAttributes& attrib)
{
  ParagraphHandler *parHandler = new ParagraphHandler(this);
  parHandler->startParagraph(attrib);
  m_paragraphs.append(parHandler);
...
IDocIterator *DetailDescriptionHandler::contents() const
{
  return new DetailDescriptionParaIterator(*this);
}
...
DocHandler::DocHandler(IBaseHandler *parent) : m_parent(parent)
{
  ...
  // addStartHandler("briefdescription",this,&DocHandler::startBriefDescription);
  addEndHandler("briefdescription",this,&DocHandler::endDoc);
  // addStartHandler("detaileddescription",this,&DocHandler::startDetailDescription);
  ...
  // addEndHandler("parameterlist",this, &DocHandler::endDoc);
  // addStartHandler("parameterlist",this, &DocHandler::startParameterList);
  // m_paramItems.setAutoDelete(TRUE);
}
...
void DocHandler::startBriefDescription(const QXmlAttributes& attrib)
{
  // m_parent->setDelegate(this);
  // debug(2,"start dochandler\n");

  // BriefDescriptionHandler *briefDescHandler = new BriefDescriptionHandler(this);
  // briefDescHandler->startParagraph(attrib);

  // m_children.append(briefDescHandler);
  debug(2,"end dochandler\n");
  m_parent->setDelegate(0);
}

void DocHandler::startDetailDescription(const QXmlAttributes& attrib)
{
  // m_parent->setDelegate(this);
  // debug(2,"start dochandler\n");

	DetailDescriptionHandler *detailDescHandler = new DetailDescriptionHandler(this);
  detailDescHandler->startParagraph(attrib);
  // m_children.append(detailDescHandler);
...
void DocHandler::startParameterList(const QXmlAttributes& attrib)
{
  ParameterListHandler *parameterListHandler = new ParameterListHandler(this);
  parameterListHandler->startParameterList(attrib);
  m_children.append(parameterListHandler);
}

IDocIterator *DocHandler::contents() const
{
  printf("DocHandler:contents().\n");
